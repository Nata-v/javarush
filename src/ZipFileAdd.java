...
public class ZipFileAdd { //добавление файла в архив(в метод мейн приходит список аргументов(1- путь к файлу,2- путь к zip-архиву))
    public static void main(String[] args) throws IOException {
        ...
        // кладем в него ZipEntry - "архивный обьект"
