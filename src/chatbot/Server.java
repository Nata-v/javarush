...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            ConsoleHelper.writeMessage("Произошла оштбка при запуске или работе сервера.");
        }
    }
    ...
    private static class Handler extends Thread {
        ...
        public void run() {
            ...
            try (Connection connection = new Connection(socket)) {
                ...
                ConsoleHelper.writeMessage("Ошибка при обмене данными " + socket.getRemoteSocketAddress());
            }
            if (userName != null) {
